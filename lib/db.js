 ...
 *
 * 다음 중 하나를 지원합니다.
 *   1) FIREBASE_SERVICE_ACCOUNT        — JSON 전체 (버셀에 붙여넣기 편함)
 *   2) FIREBASE_SERVICE_ACCOUNT_BASE64 — 위 JSON 을 base64 로 인코딩한 값
 *   3) GOOGLE_APPLICATION_CREDENTIALS  — 키 파일 경로 (구글 SDK 기본 방식)
 */
